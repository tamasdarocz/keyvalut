...
import '../../credentials/services/password_strength.dart';
import '../../settings/services/utils.dart';
  ...
  Future<void> _showRecoveryKeyDialog(String recoveryKey) async {
    await showDialog(
      ...
      builder: (dialogContext) => RecoveryKeyDialog(
        recoveryKey: recoveryKey, databaseName: _databaseNameController.text,
      ),
    );
  }
