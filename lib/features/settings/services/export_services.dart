...
class ExportService {
  ...
  static Future<void> exportData(BuildContext context, String fileName) async {
    try {
      ...
      // Fetch all core, including archived and deleted items
      ...
      // Structure JSON core without id fields
      final jsonData = {
      ...
      // Combine and encode encrypted core
      ...
      Fluttertoast.showToast(msg: 'Error exporting core: $e');
    } finally {
