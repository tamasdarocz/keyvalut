...
import 'package:keyvalut/features/shared/screens/archived_logins_screen.dart';
import 'package:keyvalut/features/auth/screens/change_login_screen.dart';
import 'package:keyvalut/features/shared/screens/deleted_credentials_screen.dart';
import 'package:provider/provider.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:keyvalut/features/auth/services/auth_service.dart';
import 'package:keyvalut/features/settings/services/export_services.dart';
import 'package:keyvalut/features/settings/services/import_service.dart';
import 'package:keyvalut/features/dialogs/delete_confirmation_dialog.dart';
import 'package:keyvalut/features/dialogs/rename_database_dialog.dart';
...
class _SettingsMenuState extends State<SettingsMenu> {
  ...
  /// Shows a dialog to export core to a JSON file.
  ///
  ...
  Future<String?> _showExportDialog() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(dialogContext).showSnackBar(
          SnackBar(content: Text('Error exporting core: $e')),
        );
      }
      return null;
    }
  ...
  /// Shows a dialog to confirm database deletion, with an option to export core first.
  ///
  /// The user is first prompted to export their core. If they proceed, they must
  ...
  Future<void> _showDeleteDatabaseDialog() async {
    ...
    final shouldProceed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Would you like to export your core before deleting the database? This action cannot be undone.'),
        actions: [
          TextButton(
